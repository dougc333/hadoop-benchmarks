...
function moddaemon {
  ...
  chown root /usr/lib/hadoop/sbin/hadoop-daemon.sh
  chgrp root /usr/lib/hadoop/sbin/hadoop-daemon.sh
  ...
  chown root /usr/lib/hadoop-yarn/sbin/yarn-daemon.sh
  chgrp root /usr/lib/hadoop-yarn/sbin/yarn-daemon.sh
}
